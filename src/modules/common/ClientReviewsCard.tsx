...
const ClientReviewsCard = ({ item, cardIndex }: { item: Testimonial; cardIndex: number }) => {
  return (
      <div
                       ...
                       >
                         ...
                         <p className="text-sm leading-7 text-ds-muted-foreground">
                           “The sourcing workflow became faster and more
                           professional after using this platform. Highly
                           recommended for apparel businesses.”
                         </p>

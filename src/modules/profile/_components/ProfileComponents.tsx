...
export const InfoPill = ({
  ...
  <span className="inline-flex items-center gap-1.5 rounded-xl border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-600 dark:border-gray-700 dark:bg-gray-800/60 dark:text-gray-300">
    {icon}
    {children}
  </span>
);
...
export const StatusBadge = ({
  ...
  const config = {
    accepted: {
      className:
        "bg-green-50 text-green-700 ring-1 ring-green-200 dark:bg-green-500/10 dark:text-green-400 dark:ring-green-500/20",
    ...
    pending: {
      className:
        "bg-amber-100/80 text-amber-900 ring-1 ring-amber-300/80 font-medium dark:bg-amber-500/10 dark:text-amber-400 dark:ring-amber-500/20",
